...
export class AppComponent {
  ...
  private async getIpCountry() {
    ...
    var countryInfo = await this.httpClient.get<any>('https://api.ipgeolocation.io/ipgeo?apiKey=949ad0172d16426a8c8303cc7844e0e1&ip=' + (ipInfo !== null ? ipInfo.ip : '')).toPromise();
