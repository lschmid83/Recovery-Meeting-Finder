...
export class DetailsDialogComponent implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer, private deviceService: DeviceDetectorService, private dialogRef: MatDialogRef<DetailsDialogComponent>, @Inject(MAT_DIALOG_DATA) data, @Inject(LOCALE_ID) private locale: string, private router: Router) {
